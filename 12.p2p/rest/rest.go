...
import (
	...
	"github.com/IMHYEWON/hyewoncoin/12.p2p/blockchain"
	"github.com/IMHYEWON/hyewoncoin/12.p2p/utils"
	"github.com/IMHYEWON/hyewoncoin/12.p2p/wallet"
...
func balance(rw http.ResponseWriter, r *http.Request) {
	...
	default:
		utils.HandleErr(json.NewEncoder(rw).Encode(blockchain.UnspentTxOutsByAddress(address, blockchain.BlockChain())))
